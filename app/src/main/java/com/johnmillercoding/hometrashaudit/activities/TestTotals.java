...
public class TestTotals extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        chart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry entry, int i, Highlight highlight) {
                ...
                {
                    Toast.makeText(TestTotals.this, combinations.get(entry.getXIndex()) + " = " + entry.getVal() + " " + units + "es", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Toast.makeText(TestTotals.this, combinations.get(entry.getXIndex()) + " = " + entry.getVal() + " " + units +"s", Toast.LENGTH_SHORT).show();
                }
            }
